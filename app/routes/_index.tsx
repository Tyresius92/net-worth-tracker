    ...
    >
      <Box xsPx={56}>
        <Box xsPy={32}>
          ...
          >
            ...
            <Text variant="deck">
              A privacy-first net worth tracker for anyone in the United States
              with accounts worth keeping track of.
            </Text>
            <Text>
                ...
                >
                  <Box xsMb={16}>
                    <Text dropCap>
                      ...
                      source you choose to add. It does not sell advertising. It
                      does not surface offers. It does not measure your savings
                      rate against a peer cohort, nor does it congratulate you
                      for any of it. The Ledger reports what is.
                    </Text>
                  </Box>
                  <Box xsMb={16}>
                    <Text>
                      ...
                      and from then on the page shows you, day after day, where
                      things stand. Balances flow in. The chart updates. Nothing
                      is shouted at you.
                    </Text>
                  </Box>
                  <Box xsMb={16}>
                    <Text>
                      Sources can be added two ways. The first is by hand, which
                      works for the parts of American finance that no API has
                      caught up with (your mortgage servicer, a CD at a credit
                      union, the cash under your mattress, the savings bond your
                      grandmother bought in 1994). The second is through wire
                      services powered by Plaid, the same connection layer your
                      bank already uses, which files figures automatically and
                      silently into your record.
                    </Text>
                  </Box>
                  <Box xsMb={16}>
                    <Text>
                  ...
                  <Box xsMb={16}>
                    <Text>
                      ...
                      weeks of using it, you find it useful, there is a tip jar.
                      The tip jar is on a separate page. It is not connected to
                      any data you see in the application, and it is the only
                      place money changes hands.
                    </Text>
                  </Box>
                  <Box xsMb={16}>
                    <Text>
          ...
          <Grid.Item xs={12} l={7}>
            <Box display="flex" flexDirection="column" xsGap={12}>
              ...
              <Text>
                ...
                surface. It must be, because the underlying business is showing
                you the next credit card. The Ledger has no underlying business
                of that kind. It will not nudge you toward a balance transfer.
                It will not tell you that you spend too much on coffee.
              </Text>
              <Text>
            ...
            >
              <Box bg="sand-3" xsP={32}>
                ...
                <Heading level={2} fontSize={36}>
                  &ldquo;The chart is monochrome on purpose. Numbers that go up
                  are not green; numbers that go down are not red. They are
                  figures.&rdquo;
                </Heading>
      ...
      <Box xsPx={56} xsPy={32}>
        ...
        >
          ...
          <Text variant="deck">
            Press credentials are the only way to use The Ledger. They are free.
            They are issued in two minutes. They open a record: a daily chart of
            all the figures recorded by your sources.
          </Text>
          <Box
            display="flex"
            justifyContent="center"
