        ...
        <Grid gap={48}>
              ...
              <Box>
                ...
                <Box pt={8}>
                  <Text variant="body">
                    ...
                    page. The body role is the workhorse: Source Serif 4 at
                    16px with a 1.5 line height, used for full sentences the
              ...
              <Box>
                ...
                <Box pt={8}>
                  <Text variant="body">
                    ...
                    copy. Your net worth today:{" "}
                    <Currency value={17238800} />.
                  </Text>
                </Box>
              </Box>
            </Box>
          ...
          <Grid.Item m={4}>
            ...
            <Box pt={12}>
              ...
              <Box pt={12} display="flex" flexDirection="column" gap={12}>
                <Box>
