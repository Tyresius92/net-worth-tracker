...
| [014](ADR-014-plaid-webhook-refresh.md)          | Plaid Webhook-Driven Balance Refresh                  | Switched from daily cron batch to per-item Plaid webhooks; supersedes ADR-006                                        |
| [015](ADR-015-bullmq-balance-refresh-queue.md)   | BullMQ Job Queue for Scheduled Balance Refresh        | Weekly safety-net refresh via node-cron + BullMQ worker; low-activity accounts refreshed regardless of webhook gap   |
